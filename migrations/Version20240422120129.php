...
final class Version20240422120129 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reviews (id INT AUTO_INCREMENT NOT NULL, sections_id INT NOT NULL, user_id INT NOT NULL, author VARCHAR(100) NOT NULL, email VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', positive LONGTEXT DEFAULT NULL, negative LONGTEXT DEFAULT NULL, text_review LONGTEXT DEFAULT NULL, INDEX IDX_6970EB0F577906E4 (sections_id), INDEX IDX_6970EB0F9D86650F (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE sections (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, price INT DEFAULT NULL, it_free TINYINT(1) NOT NULL, description LONGTEXT NOT NULL, latitude VARCHAR(255) NOT NULL, longitude VARCHAR(255) NOT NULL, contact_phone VARCHAR(15) NOT NULL, contact_email VARCHAR(255) NOT NULL, for_who LONGTEXT NOT NULL, format LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
